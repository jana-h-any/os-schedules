              ...
              onPressed: () {
                if (_validateInputs()) {
                  ...
                  if (widget.algorithm == 'FCFS') {
                    results = Scheduler.calculateFCFS(processData);
                  } else if (widget.algorithm == 'SRTF') {
                    results = Scheduler.calculateSRTF(processData);
                  } else {
                    results = [];
                  }
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ResultScreen(processes: results, algorithm: widget.algorithm),
                    ),
                  );
                } else {
